...
import { ArrowLeft, BarChart3, MessageCircle, Star, TrendingUp, Dog } from "lucide-react"
import { useTranslations, useLocale } from 'next-intl'
import { getLocalizedImage } from '@/lib/utils'

export default function CoralBayCaseStudy() {
  const t = useTranslations('coralBay')
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a1e4d] to-[#081638] text-white relative overflow-hidden">
      ...
      <div className="bg-[#081638]/80 backdrop-blur-md border-b border-[#3db4d2]/10 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/cura-farma" className="text-white/70 hover:text-white transition-colors">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-6 mt-10">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 transform transition-all hover:border-[#3db4d2]/40">
                  ...
                  <div className="text-4xl font-bold text-white mb-2">328</div>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 transform transition-all hover:border-[#3db4d2]/40">
                  ...
                  <div className="text-4xl font-bold text-white mb-2">4,3</div>
                  <div className="text-[#3db4d2] font-medium">{t('stars')}</div>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 transform transition-all hover:border-[#3db4d2]/40">
                  ...
                  <div className="text-4xl font-bold text-white mb-2">10.5x</div>
            ...
            <div>
              <div className="bg-gradient-to-br from-[#0c2a6a] to-[#081638] rounded-2xl overflow-hidden border border-[#3db4d2]/20 shadow-xl">
                ...
                <div className="w-full relative">
                  <Image
                    src="/images/coral-bay-fish-collage.png"
                    alt="Pesci tropicali di Coral Bay"
                    width={600}
                    height={400}
                ...
                <div className="grid grid-cols-2 gap-6 p-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm uppercase font-medium text-[#3db4d2]">{tCommon('founded')}</p>
                      <p className="font-medium text-white">2010</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm uppercase font-medium text-[#3db4d2]">{tCommon('region')}</p>
                      <p className="font-medium text-white">Roma, Italia</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm uppercase font-medium text-[#3db4d2]">{tCommon('website')}</p>
                      <p className="font-medium text-white">coralbaysrl.it</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
          ...
          <div className="bg-gradient-to-br from-[#0c2a6a] to-[#081638] p-8 rounded-2xl border border-[#3db4d2]/20 shadow-xl">
            ...
            <div className="mt-8 bg-white/5 p-6 rounded-xl">
              <div className="flex items-center">
                <div className="w-20 h-20 rounded-full overflow-hidden bg-[#3db4d2] flex items-center justify-center mr-5 shrink-0">
                  <Image
                    src="/images/coral-bay-owner.png"
                    alt="Proprietario di Coral Bay"
                    width={80}
                    height={80}
                ...
                <div>
                  <p className="text-white/80 text-sm">Maurizio Della Torre / Founder "Coral Bay"</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-r from-[#3db4d2]/30 to-[#3db4d2]/10 rounded-xl blur-sm"></div>
                  <Image
                    src={getLocalizedImage('coral-bay-website.png', locale, '.jpg')}
                    alt="Sito web Coral Bay"
                    width={600}
                    height={400}
                    className="w-full rounded-lg shadow-lg relative"
                  />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              ...
              <div className="space-y-6">
                ...
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-r from-[#3db4d2]/30 to-[#3db4d2]/10 rounded-xl blur-sm"></div>
                  <Image
                    src="/images/coral-bay-reviews.png"
                    alt="Recensioni dei clienti Coral Bay"
                    width={600}
                    height={400}
                    className="w-full rounded-lg shadow-lg relative"
                  />
        ...
        <div className="mb-16">
          <div className="bg-gradient-to-br from-[#0c2a6a] to-[#081638] p-8 rounded-2xl border border-[#3db4d2]/20 shadow-xl">
            <h2 className="text-3xl font-bold text-[#3db4d2] mb-8">{t('whatsappTemplate')}</h2>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <p className="text-white leading-relaxed text-lg mb-6">
                  {t('whatsappTemplateText1')}
                </p>

                <ul className="list-disc list-inside text-white space-y-2 mb-6 ml-4">
                  <li className="text-lg">{t('templatePoint1')}</li>
                  <li className="text-lg">{t('templatePoint2')}</li>
                  <li className="text-lg">{t('templatePoint3')}</li>
                  <li className="text-lg">{t('templatePoint4')}</li>
                </ul>

                <p className="text-white leading-relaxed text-lg">
                  {t('whatsappTemplateText2')}
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <Image
                  src="/images/coral-bay-fish-collage.png"
                  alt="Template WhatsApp di Coral Bay"
                  width={600}
                  height={800}
                  className="w-full rounded-lg shadow-lg relative"
                />
