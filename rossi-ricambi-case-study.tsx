...
export default function RossiRicambiCaseStudy() {
  const t = useTranslations('rossiRicambi')
  const tCommon = useTranslations('common')
  const badges = ["reviews", "automation", "sales"]
  
  // Badge configuration
  const badgeConfig = {
    reviews: { label: t('reviews'), color: "bg-green-500/20 text-green-400 border-green-500/30" },
    ...
    roi: { label: "ROI", color: "bg-orange-500/20 text-orange-400 border-orange-500/30" },
    growth: { label: "Growth", color: "bg-pink-500/20 text-pink-400 border-pink-500/30" },
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a1e4d] to-[#081638] text-white relative overflow-hidden">
      ...
      <div className="bg-[#081638]/80 backdrop-blur-md border-b border-[#3db4d2]/10 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="/coltelleria-store" className="text-white/70 hover:text-white transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="inline-block bg-[#1a4080] text-white px-4 py-1 rounded-full text-sm font-medium">
                  {t('category')}
                </div>
                {/* Badges */}
                <div className="flex gap-2">
                  {badges.map((badge, index) => (
                    <span
                      key={index}
                      className={`px-3 py-1 rounded-full text-xs font-medium border backdrop-blur-sm ${badgeConfig[badge]?.color || "bg-gray-500/20 text-gray-400 border-gray-500/30"}`}
                    >
              ...
              <div className="grid grid-cols-2 gap-6 mt-10">
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 transform transition-all hover:border-[#3db4d2]/40">
                  ...
                  <div className="text-4xl font-bold text-white mb-2">5390</div>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 transform transition-all hover:border-[#3db4d2]/40">
                  ...
                  <div className="text-[#3db4d2] font-medium">{t('months')}</div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="bg-gradient-to-br from-[#0c2a6a] to-[#081638] rounded-2xl overflow-hidden border border-[#3db4d2]/20 shadow-xl">
                ...
                <div className="w-full relative">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-3ZUwVTy18nHUpSmkVA6V2yPu1KL41K.png"
                    alt="Team Rossi Ricambi"
                    width={600}
                    height={400}
                ...
                <div className="grid grid-cols-2 gap-6 p-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm uppercase font-medium text-[#3db4d2]">{tCommon('sector')}</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-white">1500 {t('ordersPerMonth')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-white">Messina, Italy</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-white">rossiricambi.it</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 z-10">
        ...
        <div className="mb-16">
          <div className="bg-gradient-to-br from-[#0c2a6a] to-[#081638] p-8 rounded-2xl border border-[#3db4d2]/20 shadow-xl">
            ...
            <div className="mt-8 bg-white/5 p-6 rounded-xl">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-whVe7hqpYwU8sW8GKUH2OH0TbYbccz.png"
                alt="Sito web Rossi Ricambi"
                width={800}
                height={450}
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-white/80 text-sm">Pierluigi Rossi / Owner "Rossi Ricambi"</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <div className="relative">
                  ...
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-r70Hv5i8orYvYhNKUCm0GXviQHuosr.png"
                    alt="Sistema di gestione ricambi e messaggio WhatsApp"
                    width={600}
                    height={400}
        ...
        <div className="mb-16">
          <div className="bg-gradient-to-br from-[#0c2a6a] to-[#081638] p-8 rounded-2xl border border-[#3db4d2]/20 shadow-xl">
            <h2 className="text-3xl font-bold text-[#3db4d2] mb-8">{t('resultsTitle')}</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              <div>
                ...
                <div className="bg-white/5 p-6 rounded-xl mb-6">
                  <h3 className="text-xl font-bold text-[#3db4d2] mb-3">{t('resultsResult')}</h3>
                ...
                <div className="bg-white/5 p-6 rounded-xl">
                  <h3 className="text-xl font-bold text-[#3db4d2] mb-3">{t('businessImpact')}</h3>
                  <p className="text-white leading-relaxed">
                    {t('businessImpactText')}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-r from-[#3db4d2]/30 to-[#3db4d2]/10 rounded-xl blur-sm"></div>
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-UjaLZlJxTLj8fEU3OUrIUEKyNqwikG.png"
                ...
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-r from-[#3db4d2]/30 to-[#3db4d2]/10 rounded-xl blur-sm"></div>
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-87biWTPO5dd2ScpXAtCPCdeMzKL3RL.png"
                    alt="Recensione cliente Aldo"
                    width={600}
                    height={200}
                    className="w-full rounded-lg shadow-lg relative"
                  />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <div className="bg-[#0c2a6a] rounded-xl p-6 border-2 border-[#3db4d2]/30 relative">
                  ...
                  <h3 className="text-xl font-bold text-[#3db4d2] mb-4">{t('moreRecurringCustomers')}</h3>
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <p className="font-bold text-white">Aldo</p>
                      <p className="text-sm text-white/70">3 settimane fa</p>
                    </div>
                    <div className="ml-auto">
                      <span className="bg-[#3db4d2]/30 text-white text-xs font-medium px-2 py-0.5 rounded">NUOVA</span>
                    </div>
                  </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-[#3db4d2]/30 transition-all">
              <div className="w-14 h-14 rounded-full bg-[#3db4d2]/20 flex items-center justify-center mb-4">
                <BarChart3 className="h-7 w-7 text-[#3db4d2]" />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-8">
              ...
              <Link href="/coltelleria-store" className="text-white/60 hover:text-[#3db4d2] transition-colors">
                {tCommon('nextCaseStudy')}
              </Link>
            </div>
          </div>
